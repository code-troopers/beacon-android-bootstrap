...
public class SettingsActivity extends PreferenceActivity {
    public static final String ON_LOST_TIMEOUT_SECS_KEY = "onLostTimeoutSecs";
    public static final String SHOW_DEBUG_INFO_KEY = "showDebugInfo";
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            if (key.equals(ON_LOST_TIMEOUT_SECS_KEY)) {
                ...
                String summary = String.format(Locale.getDefault(),
                        "Remove from the list devices that haven't been sighted in %d %s. 0 means never remove.",
                        sharedPreferences.getInt(key, 5), unit);
